...
- 해결하고 싶은 점 :
     1. 코드 먼저 만들지 않고, 구상 단계를 충분히 가지기.
        1-1. 어떤 프로그램을 만들지
        1-2. 그 프로그램에 어떤 기능을 넣어야 할 지
        1-3. 기능 구현을 위해 필요한 클래스는 무엇이 있는지
        1-4. 클래스도 각자 어떤 기능을 담당하며 무엇을 기준으로 묶어줄지
     2. 다이어그램 등을 통한 아이디어의 구체화, 시각화 + 프로세스 파악 후 숙지
     3. 현재 가용할 수 있는 자원들로 해결 가능한 범위
     ...
